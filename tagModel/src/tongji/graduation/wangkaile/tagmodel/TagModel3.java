...
public class TagModel3 {
		...
		protected void setup(Context context) throws IOException,
			...
			if (localCacheFiles != null) {
				for (int i = 0; i < localCacheFiles.length; i++) {
					...
					try {
						W13 = (Hashtable<Integer, Hashtable<Integer, Double>>) in.readObject();
						W23 = (Hashtable<Integer, Hashtable<Integer, Double>>) in.readObject();
	...
	public static void main(String[] args) throws Exception {
		...
		DistributedCache.addCacheFile(new URI("/usr/wangkaile/tagmodel/parameters/parameter"),
				conf);
		conf.setInt("io.sort.mb", 200);
		conf.set("mapred.child.java.opts", "-Xmx2048m");
		String input = "/usr/wangkaile/tagmodel/input/input0";
		String output = "/usr/wangkaile/tagmodel/input/input1";
